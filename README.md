...
- **Reservas**: creación desde la tarjeta del equipo (requiere sesión), historial en tabla con paginación, filtro "solo mis reservas" y cancelación.
...
- **Responsive**: grillas que colapsan por breakpoint y tablas con scroll horizontal en pantallas angostas.
