...
[Inicio](../../README.md) · [Evidencias](14-evidencias.md) · [Checklist](EVIDENCE_CHECKLIST.md)
...
El primer barrido encontró que la tabla de equipos se activaba desde `md` y recortaba acciones a 768 px. Se elevó a `xl`: cards completas en tablet y tabla únicamente cuando caben todas las columnas. El barrido final no reportó overflow horizontal.

## Estrategia aplicada

- `AppShell`: `min-w-0`, contención horizontal, padding/gaps progresivos, encabezado y acciones apilables.
- Equipos/admin: cards en móvil/tablet; tabla desktop con scroll controlado como defensa adicional.
